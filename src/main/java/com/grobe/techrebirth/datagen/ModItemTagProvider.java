...
public class ModItemTagProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider){
        ...
        for(var tagKey : ModTags.Items.GOLD_DUST_D.both())    tag(tagKey).add(ModItems.GOLD_POWDER.get());
        ...
        for(var tagKey : ModTags.Items.PURIFIED_TIN_DUST_D.both())   tag(tagKey).add(ModItems.PURIFIED_TIN_POWDER.get());
        for(var tagKey : ModTags.Items.PURIFIED_NICKEL_DUST_D.both())   tag(tagKey).add(ModItems.PURIFIED_NICKEL_POWDER.get());
        ...
        tag(catalystsBoth[0])
                .addTag(ModTags.Items.CATALYST_DIAMOND.neoforge())
                .addTag(ModTags.Items.CATALYST_BLAZE.neoforge());
        tag(catalystsBoth[1])
                .addTag(ModTags.Items.CATALYST_DIAMOND.common())
        ...
        tag(dustsBoth[0])
                ...
                .addTag(ModTags.Items.GOLD_DUST_D.neoforge())
        ...
        tag(dustsBoth[1])
                ...
                .addTag(ModTags.Items.GOLD_DUST_D.common())
